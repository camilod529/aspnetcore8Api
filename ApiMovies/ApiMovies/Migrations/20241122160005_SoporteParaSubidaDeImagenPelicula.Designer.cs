...
namespace ApiMovies.Migrations
{
    ...
    [Migration("20241122160005_SoporteParaSubidaDeImagenPelicula")]
    partial class SoporteParaSubidaDeImagenPelicula
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiMovies.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ApiMovies.Models.Movie", b =>
                {
                    ...
                    b.Property<string>("LocalImageRoute")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ApiMovies.Models.AppUser", null)
                        .WithMany()
